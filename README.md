...
- Roadmap-derived learner tools: audio-first practice session, private journal, personal lexicon builder, multi-track practice plan, and top-down lesson/resource catalog
...
```bash
FIREBASE_PROJECT_ID=kambradu npm run seed:firestore -- scripts/seeds/kristang-curated-sample.json
```
...
The local MVP follows the HeadsUp / LevelHeads product language: dark operational rail, yellow/black active states, hard-bordered dashboard surfaces, compact navigation, and Hegel the owl as the app mark. See `docs/design/README.md`.
