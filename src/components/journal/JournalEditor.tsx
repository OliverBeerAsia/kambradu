...
import { kristangCommunity, starterJournalEntries } from "@/data/kristang";
...
export function JournalEditor() {
  const { activeCycle, attachJournalEntry, isHydrated: cyclesReady } = useLearningCycles();
  const [entries, setEntries, entriesReady] = useLocalStorageState<JournalEntry[]>(MEMORY_STORAGE_KEYS.journal, starterJournalEntries);
  ...
  if (!cyclesReady || !entriesReady) {
    return <section className="learner-grid"><p role="status">Preparing your memories...</p></section>;
  }
